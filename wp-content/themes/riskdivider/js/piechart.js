...
function renderPieChart (dataset,dom_element_to_append_to, colorScheme){
  ...
  var svg = d3v4.select(dom_element_to_append_to)
  .append("svg")
  .attr("width", width)
  .attr("height", height)
  .append("g")
  ...
  var tooltip = d3v4.select(dom_element_to_append_to)
  .append('div')
  .attr('class', 'tooltip');
  ...
  var total = d3v4.sum(dataset.map(function(d) {
  ...
  path.on('mousemove', function(d) {
    tooltip.style('top', (d3v4.event.layerY + 10) + 'px')
    .style('left', (d3v4.event.layerX - 25) + 'px');
  });
  ...
  .on('click', function(label) {
    var rect = d3v4.select(this);
    var enabled = true;
    var totalEnabled = d3v4.sum(dataset.map(function(d) {
  ...
  var legend5 = d3v4.select('.legend5');
    
  legend5.selectAll("legend").data(color.domain()).enter().append("div")
  .attr("class","legend").append("div").style("background", color );
  legend5.selectAll('.legend').append("span").html(function(d,i) { return d } )
